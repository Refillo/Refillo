...
const SECTOR_COLORS = {
  'Automotive': '#059669', // Emerald 600
  'Energy': '#047857',     // Emerald 700
  'Retail & Fashion': '#10b981', // Emerald 500
  ...
  return (
    <div ref={containerRef} className="w-full overflow-hidden relative py-12">
      ...
      <ForceGraph2D
        ...
        nodeColor={node => {
          if (highlightedNode && node.id === highlightedNode) return '#047857';
          return SECTOR_COLORS[node.sector] || SECTOR_COLORS.General;
        }}
        nodeRelSize={6}
        linkDirectionalParticles={2}
        linkDirectionalParticleSpeed={0.003}
        linkColor={() => 'rgba(5, 150, 105, 0.1)'}
        ...
        nodeCanvasObject={(node, ctx, globalScale) => {
          ...
          ctx.fillStyle = isHighlighted ? '#047857' : (SECTOR_COLORS[node.sector] || SECTOR_COLORS.General);
          ctx.fill();
          ...
          if (globalScale > 0.8 || isHighlighted) {
            ...
            ctx.fillStyle = isHighlighted ? '#047857' : '#334155';
