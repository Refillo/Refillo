      ...
      <section className="px-6 md:px-12 py-32 md:py-48 max-w-7xl mx-auto">
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-lg md:text-xl font-medium mb-12 max-w-xl mx-auto tracking-tight">Iscriviti alla nostra newsletter per ricevere approfondimenti mensili sull'ESG e l'automazione dei dati.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input type="email" placeholder="La tua email" className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-emerald-500 transition-all flex-1" />
              <button className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black text-sm hover:bg-emerald-700 transition-all active:scale-95 shadow-xl shadow-emerald-500/20">Subscribe</button>
            </div>
          </div>
          <div className="absolute top-0 right-0 w-full h-full bg-emerald-500/[0.03] blur-[100px] rounded-full pointer-events-none"></div>
        </motion.div>
      </section>
